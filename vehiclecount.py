...
width_min=80 #minimum rectangular width
altura_min=80 #Altura minima do retangulo

offset=6 #Erro allowed enter pixel  

pos_line=550 #Line position if count
...
while True:
    ...
    for(i,c) in enumerate(contorno):
        ...
        validar_contorno = (w >= width_min) and (h >= altura_min)
